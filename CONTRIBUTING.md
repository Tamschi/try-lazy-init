...
[bugs]: https://github.com/Tamschi/try-lazy-init/issues/new?assignees=&labels=bug&template=bug_report.md&title=
[feature requests]: https://github.com/Tamschi/try-lazy-init/issues/new?assignees=&labels=enhancement&template=feature_request.md&title=
["Custom issue"]: https://github.com/Tamschi/try-lazy-init/issues/new?assignees=&labels=&template=custom_issue.md&title=
...
Please add yourself to each copyright holders list [LICENSE](LICENSE) when contributing, or alternatively include a note in your pull request that you intentionally didn't do so.
